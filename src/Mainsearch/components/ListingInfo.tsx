...
const ListingInfo = () => {
  return (
    <div id="info__container">
      ...
      {/* <div className="info__row"> */}
          {/* <div id="info__days" className="listing__misc">1d ago</div>
          <div id="info__position" className="listing__misc"> Full Time</div>
          <div id="info__location" className="listing__misc">USA only</div> */}
